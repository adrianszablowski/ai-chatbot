				...
				<div className='space-y-4 lg:order-last'>
					...
					<ul className='grid gap-4'>
						<li className='flex items-start gap-2'>
							...
							<div>
								<h3 className={`text-lg font-bold ${cormorant_garamond.className}`}>Personalized Responses</h3>
						...
						<li className='flex items-start gap-2'>
							<CheckIcon className='mt-1 h-5 w-5 flex-shrink-0 text-primary' />
							<div>
								<h3 className={`text-lg font-bold ${cormorant_garamond.className}`}>Seamless Integration</h3>
								<p className='text-muted-foreground'>
						...
						<li className='flex items-start gap-2'>
							<CheckIcon className='mt-1 h-5 w-5 flex-shrink-0 text-primary' />
							<div>
								<h3 className={`text-lg font-bold ${cormorant_garamond.className}`}>Multilingual Support</h3>
								<p className='text-muted-foreground'>
